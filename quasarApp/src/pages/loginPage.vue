    ...
    <div id="main_container" class="column no-wrap">
      ...
      <div class="main_inner_wrap">
        <div class="no-login-div" v-if="loginInfo.loginState == false">
          <div class="outer">
            <div class="inner">
              <div class="text_block top_text_block">인증된 업체들을 통해 믿을 수 있는 확실한 서비스를 제공받으세요.</div>
              <div class="btn_sns_list">
                ...
                <a
                  ...
                  id="login-kakao"
                  class="login-kakao"
                  onclick="$('#kakao-login-btn').click();"
                >
                  <i>카카오</i>
                </a>
                <a href="#" class="login-facebook" id="login-facebook" onclick="alert('개발중입니다.');">
                  <i>페이스북</i>
                </a>
                <a
                  href="#"
              ...
              <div class="text_block">Copyright ⓒ 2018 착한자동차공업사. All rights reserved.
                <br>
                <br>
                <br>고객센터 1234-5678 (평일 10:00 ~ 18:00)
                <br>
                <br>이메일 : sample@naver.com
                <br>
                <br>(주) 착한자동차공업사|대표 : 홍길동|사업자번호 : 144-81-21245
                <br>
                <br>경기도 부천시 원미구 신흥로59번길 44-7
                <br>
                <br>
                <br>
                <br>사용자 이용약관|개인정보 취급방침|위치정보 서비스 이용약관
              </div>
            </div>
          </div>
        </div>
        <div class="login-div" v-if="loginInfo.loginState == true">
          <div class="row justify-center">
            <div class="profile-img-div">
              <img
                v-bind:src="loginInfo.thumbnailImage != '' ? loginInfo.thumbnailImage : defaultImage()"
                alt="profile-image"
                class="shadow-1 profile-img"
              >
            </div>
          </div>
...
.login_page_wrap .btn_sns_list i {
  height: 12px;
  margin: 2.5px 0;
  background: url("https://ssl.tourbaksa.com/images/sub/member/sns_pcbtn_set.png")
    no-repeat 0 0;
